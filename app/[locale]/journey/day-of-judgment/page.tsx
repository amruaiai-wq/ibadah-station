...
export default function DayOfJudgmentPage({ params: { locale } }: { params: { locale: string } }) {
  const t = useTranslations('dayOfJudgment');
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 text-white py-16 relative overflow-hidden">
        {/* Animated Pattern */}
        <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center">
            ...
            <motion.p
              className="text-3xl font-arabic text-amber-300 mb-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <div className="text-center">
                <p className="text-3xl font-bold text-amber-300">{steps.length}</p>
