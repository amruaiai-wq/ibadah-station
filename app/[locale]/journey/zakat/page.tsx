...
export default function ZakatPage() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-violet-600 via-violet-700 to-violet-900 text-white py-16 relative overflow-hidden">
        <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center">
            ...
            <motion.div className="flex justify-center gap-8 mt-8" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}>
              ...
              <div className="text-center">
                <p className="text-3xl font-bold text-gold">2.5%</p>
                <p className="text-white/60 text-sm">{locale === 'th' ? 'อัตราซะกาต' : 'Zakat Rate'}</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-gold">1x</p>
                <p className="text-white/60 text-sm">{locale === 'th' ? 'ต่อปี' : 'Yearly'}</p>
              </div>
            </motion.div>
          </div>
        </div>
