    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <JourneyMapNew steps={steps} journeyIcon="🌅" journeyColor="sky" onStepClick={handleStepClick} locale={locale} externalCurrentStep={isPopupOpen ? selectedIndex : undefined} />
        </div>
      </section>
