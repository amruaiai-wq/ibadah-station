...
export default function PostPrayerAdhkarPage({ params: { locale } }: { params: { locale: string } }) {
    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <JourneyMapNew steps={steps} journeyIcon="📿" journeyColor="purple" onStepClick={handleStepClick} locale={locale} />
        </div>
      </section>
