...
export default function DailyDuasPage() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-rose-500 via-rose-600 to-rose-800 text-white py-16 relative overflow-hidden">
        <motion.div
          ...
          <div className="text-center">
            ...
            <motion.div className="flex justify-center gap-8 mt-8" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}>
              ...
              <div className="text-center">
                ...
                <p className="text-white/60 text-sm">{locale === 'th' ? 'ทุกโอกาส' : 'All Occasions'}</p>
              </div>
            </motion.div>
          </div>
        </div>
