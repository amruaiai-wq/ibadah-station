...
export default function HajjPage() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-stone-600 via-stone-700 to-stone-900 text-white py-16 relative overflow-hidden">
        {/* Animated Pattern */}
        <motion.div
          ...
          <div className="text-center">
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-white/60 text-sm">{locale === 'th' ? 'วัน' : 'Days'}</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-gold">1x</p>
                <p className="text-white/60 text-sm">{locale === 'th' ? 'ในชีวิต' : 'Lifetime'}</p>
              </div>
            </motion.div>
          </div>
        </div>
