...
export default function IslamicBattlesPage() {
  const { locale } = useParams<{ locale: string }>();
  const t = useTranslations('islamicBattles');
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-red-700 via-red-800 to-red-900 text-white py-16 relative overflow-hidden">
        {/* Animated Pattern */}
        <motion.div
          ...
          <div className="text-center">
            ...
            >
              <div className="text-center">
                ...
                <p className="text-white/60 text-sm">{locale === 'th' ? 'สงคราม' : 'Battles'}</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-gold">624-632</p>
