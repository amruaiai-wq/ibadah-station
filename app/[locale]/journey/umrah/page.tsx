...
export default function UmrahPage({ params: { locale } }: { params: { locale: string } }) {
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-teal-600 via-teal-700 to-teal-900 text-white py-16 relative overflow-hidden">
        {/* Animated Pattern */}
        <motion.div 
          ...
          <div className="text-center">
            ...
            >
              <div className="text-center">
                ...
                <p className="text-white/60 text-sm">{locale === 'th' ? 'ขั้นตอน' : 'Steps'}</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-gold">2-3</p>
                <p className="text-white/60 text-sm">{locale === 'th' ? 'ชั่วโมง' : 'Hours'}</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-gold">∞</p>
                <p className="text-white/60 text-sm">{locale === 'th' ? 'ผลบุญ' : 'Rewards'}</p>
              </div>
            </motion.div>
          </div>
        </div>
