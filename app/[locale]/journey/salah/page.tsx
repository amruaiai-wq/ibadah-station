...
export default function SalahPage({ params: { locale } }: { params: { locale: string } }) {
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-900 text-white py-16 relative overflow-hidden">
        {/* Animated Pattern */}
        <motion.div 
          ...
          <div className="text-center">
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-white/60 text-sm">{locale === 'th' ? 'นาที' : 'Minutes'}</p>
              </div>
              <div className="text-center">
