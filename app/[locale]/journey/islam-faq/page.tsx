      ...
      <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center">
            ...
            <motion.p
              className="text-3xl font-arabic text-blue-200 mb-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <div className="text-center">
                <p className="text-3xl font-bold text-blue-200">{steps.length}</p>
                <p className="text-white/60 text-sm">{locale === 'th' ? 'คำถาม' : 'Questions'}</p>
              </div>
            </motion.div>
          </div>
        </div>
