...
export default function LoginForm({ locale, translations: t }: LoginFormProps) {
    ...
    >
      <div className="bg-white rounded-2xl shadow-xl p-8">
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          {t.noAccount}{' '}
          <Link href={`/${locale}/auth/register`} className="text-primary hover:text-primary-dark font-semibold">
            {t.register}
          </Link>
        </p>
      </div>
